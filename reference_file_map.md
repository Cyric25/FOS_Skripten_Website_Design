...
_Stand: 2026-08-08 · Theme-Version 1.5.74_
...
| `includes/admin/page-manager.php` | Seitenübersicht im Admin mit Drag-Sortierung | Anlegen/Löschen/Status-Umschalten per AJAX; **ändert `post_parent` und `menu_order` direkt per `$wpdb->update`, also an `save_post` vorbei** | `dist/js/page-manager.js` |
...
| `src/js/page-manager.js` | Drag-Sortierung im Seitenmanager | – | `includes/admin/page-manager.php` |
...
| `src/css/page-manager.css` | Gestaltung des Seitenmanagers | – | – |
